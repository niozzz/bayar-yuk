                            ...
                            <br>
                                <form
                                    ...
                                    <div class="field item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" value="{{ $piutang-> jumlah_tpiutang }}" type="number" name="jumlah_tpiutang" id="jumlah_tpiutang" data-validate-minmax="10,100" required="required"></div>
                                    </div>
