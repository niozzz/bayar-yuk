    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Catatan Transaksi Piutang</h3>
            </div>
        </div>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <a href="/transaksi/tambah-piutang" class="btn btn-sm btn-info">Tambah Piutang</a>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @php $tanggalTpiutang = strtotime($data-> tanggal_tpiutang); $tanggalTpiutang =
                                                date('d/m/Y', $tanggalTpiutang); @endphp
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button
                                                        ...
                                                        data-bs-target="#modalDetail{{$data -> id_tpiutang}}">
                                                        Detail
                                                    </button>
                                                    @else
                                                    <button
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a
                                                            ...
                                                            href="/transaksi/ubah-piutang/{{$data-> id_tpiutang}}">Ubah</a>
                                                        <button
                                                            class="btn btn-sm btn-danger"
                                                            type="button"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#deleteData{{$data -> id_tpiutang}}">Hapus</button>
                                                    </div>
                                                </td>
                                            </tr>
                                            @endif @endforeach
...
<div
    class="modal fade"
    id="modalDetail{{$data-> id_tpiutang}}"
                                    ...
                                    <br>
                                        ...
                                        <br>
                                            ...
                                            <img src="{{ url('gambar/bukti/' . $data -> bukti_tpiutang) }}" width="100%">
                                                ...
                                                <br>
                                                    <br>
                                                        <form action="/transaksi/piutang/confirm/{{$data-> id_tpiutang}}" method="POST">
                                                            @csrf
                                                            <b>Password</b>
                                                            :
                                            ...
                                            <div
                                                class="modal fade"
                                                id="deleteData{{$data-> id_tpiutang}}"
                                                data-bs-backdrop="static"
                                                data-bs-keyboard="false"
                                                tabindex="-1"
                                                aria-labelledby="staticBackdropLabel"
                                                ...
                                                <div class="modal-dialog modal-sm modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a
                                                                href="/transaksi/hapus-piutang/{{$data-> id_tpiutang}}"
